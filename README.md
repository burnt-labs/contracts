...
| XION Markets Factory Contract | Protocol's proxy/deployer contract for all the markets. Responsible for enumerables and indexing of data and statistics across the XIONMarkets protocol. | [v1.0.0](https://github.com/XIONMarkets/xionmarkets-smart-contracts) | [XION Markets](https://x.com/xionmarkets) | `56` | `C877A97EDEA41408088644E7CE205C141C472C822EA7033E0439274928CC1D99` | [27](https://www.mintscan.io/xion/proposals/27) |
| XION Markets Market Contract | Model for the markets (events) that facilitates trading of shares (Yes or No), provision of liquidity, removal of liquidity and all core functionality of the protocol. | [v1.0.0](https://github.com/XIONMarkets/xionmarkets-smart-contracts) | [XION Markets](https://x.com/xionmarkets) | `57` | `4CFC7E3BB774D3528749A10582652218910CF9344514F59C88A1EC15C128BAA7` | [27](https://www.mintscan.io/xion/proposals/27) |
| Pyth Oracle Contract | Pyth Network price feeds contract providing real-time financial market data to smart contract applications | [v1.0.0](https://github.com/pyth-network/pyth-crosschain/tree/main/target_chains/cosmwasm) | [Pyth Network](https://www.pyth.network/) | `58` | `CA4DEAD04CFFC986BB05B9FA792327AC4EA2609EC928EF44DD7F48D3E16995F5` | [28](https://www.mintscan.io/xion/proposals/28) |
| Pyth Oracle Wormhole Dependency | Wormhole dependency for the Pyth Network oracle implementation | [v1.0.0](https://github.com/pyth-network/pyth-crosschain/tree/main/target_chains/cosmwasm) | [Pyth Network](https://www.pyth.network/) | `59` | `42133359E82BF07E446F6E75D360A0E1F4E164C66138AA4A5D2EDA3A75005026` | [28](https://www.mintscan.io/xion/proposals/28) |
