    ...
    impl Querier for CustomQuery {
        fn raw_query(&self, _bin_request: &[u8]) -> QuerierResult {
            ...
            let res: QueryDkimPubKeysResponse = QueryDkimPubKeysResponse {
                dkim_pub_keys: vec![
                    DkimPubKey { domain: "google.com".to_string(), pub_key: "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA4zd3nfUoLHWFbfoPZzAb8bvjsFIIFsNypweLuPe4M".to_string(), poseidon_hash: Binary::from_base64("RjMpmQQPLhucCCEh0ouEDTeEkh4+IyOHCrVjy0R1iyo=").unwrap().into(), selector: "20230601".to_string(), version: 0, key_type: 0 }
                ],
                pagination: None,
            };
