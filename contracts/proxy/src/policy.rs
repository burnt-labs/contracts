...
use crate::{
    error::ContractError,
    msg::ProxyAction,
    state::{ALLOWED_OPERATORS, COLLECTIONS, Config},
};
...
pub fn check(
    ...
    match action {
        ...
        // available for any operator, in particular one the admin removed after an
        // incident. The collection validates the address.
        ProxyAction::RevokeAll { .. } => Ok(()),
